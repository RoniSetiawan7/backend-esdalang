...
<div class="row">
    <div class="col-lg-12 margin-tb mb-3">
        <a href="{{ route('create-materi') }}" class="btn btn-success float-right"><i class="fas fa-plus"></i> Tambah
            Data</a>
    </div>
</div>
...
<div class="card shadow mb-4 border-left-primary shadow h-100 py-2">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-book text-gray-500"></i> Data Materi
        </h6>
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table id="dataMateri" class="display">
                <thead>
                    <tr align="center">
                        <th>Kode Materi</th>
                        <th>Nama Materi</th>
                    ...
                    @foreach ($subject as $sub)
                        <tr align="center">
                            ...
                            <td align="right">
                                ...
                                <a href="{{ route('destroy-materi', $sub->kode_materi) }}"
                                    class="btn btn-danger btn-sm" role="button"
                                    onclick="return confirm('Yakin ingin menghapus data {{ $sub->nm_materi }}?')"><i
            ...
            @push('scripts')
                ...
                <script>
                    $(document).ready(function() {
                        var table = $('#dataMateri').DataTable();
