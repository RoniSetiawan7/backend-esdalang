...
@section('main-content')
    ...
    <div class="row">
        ...
        <!-- Hasil Latihan -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ route('index-hasilLatihan') }}" style="text-decoration:none">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-secondary mb-1">
                                    HASIL LATIHAN
                                    <?php
                                    $hasilLatihan = DB::table('hasil_latihan')->count();
                                    ?></div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $hasilLatihan }}</div>
                            </div>
                            <div class="col-auto">
