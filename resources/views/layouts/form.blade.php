...
<head>
    ...
    <!-- Hide spin button form input number -->
    <style>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ Route::is('home') || Route::is('home') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMenu" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('index-materi') }}">Data Materi</a>
                        <a class="collapse-item" href="{{ route('indexLatihan') }}">Data Latihan</a>
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item {{ Route::is('profile') || Route::is('profile') ? 'active' : '' }}">
            ...
            <!-- Nav Item - About -->
            <li class="nav-item {{ Route::is('about') || Route::is('about') ? 'active' : '' }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; RoniSetiawan 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
